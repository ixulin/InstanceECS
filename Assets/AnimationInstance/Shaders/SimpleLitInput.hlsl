...
CBUFFER_END
    ...
    #define _AnimOffset         UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__AnimOffset)
    #define _AnimationType      UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__AnimationType)
